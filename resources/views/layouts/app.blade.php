					...
					<div id="NavStat_P2">
											...
											<ul id="Notification-DropDown">
												...
												<div id="ListOfNotif">
                                                    ...
                                                    <a href="#" class="Notif-Lists" data-Type="Request">
														<li>
															<img src="/storage/images/sample.jpeg" alt="">
                        ...
                        @else
                            <div id="Registered">
								...
								<div id="Img-But">
									<a href="#" id="Heart"><img src="image/png/Heart.png" alt=""></a>
									<ul>
										<li id="Notification-holder">
											<img id="Notification" src="image/png/Notification.png" alt="">
											<ul id="Notification-DropDown">
												<div id="Notification-DropDown-header">
													<p onclick="wew(this)">Notification</p>
													<span>5</span>
